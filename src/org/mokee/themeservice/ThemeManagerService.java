...
public class ThemeManagerService extends Service {
    ...
    private HandlerThread mResourceProcessingWorker;
    ...
    private AppsFailureReceiver mAppsFailureReceiver;
    ...
    private IBinder mService = new IThemeService.Stub() {
        ...
        public int getProgress() throws RemoteException {
            synchronized(ThemeManagerService.this) {
                return mProgress;
            }
        }
    ...
    public void onCreate() {
        ...
        mResourceProcessingWorker = new HandlerThread("ResourceProcessingThread",
                Process.THREAD_PRIORITY_BACKGROUND);
        mResourceProcessingWorker.start();
        mResourceProcessingHandler = new ResourceProcessingHandler(
                mResourceProcessingWorker.getLooper());
    ...
    public void onDestroy() {
        mWorker.quit();
        mResourceProcessingWorker.quit();
    ...
    private void unregisterAppsFailureReceiver() {
        unregisterReceiver(mAppsFailureReceiver);
    }
    ...
    private void updateProvider(ThemeChangeRequest request, long updateTime) {
        ...
        for (String component : componentMap.keySet()) {
            ...
            getContentResolver().update(MixnMatchColumns.CONTENT_URI, values, where,
                    selectionArgs);
        }
    }
